      ...
      <div className="lg:grid lg:grid-cols-5 relative lg:mt-3 ">
        <div className="lg:order-last lg:col-span-3">
          <div className="flex justify-center items-center pt-2  ">
            <Image
              src="/Images/extras/sign-cropped.svg"
              alt="rightImage"
              width={200}
              height={200}
        ...
        <div className=" lg:col-span-2 ">
          ...
          <div className="space-y-8">
            <div className="lg:flex space-y-5 lg:space-y-0 lg:gap-2 ">
              <Input
                type="text"
                name="firstName"
                required
                placeholder="First Name"
                className="bg-white lg:w-full flex-1 border placeholder-black border-b border-t-0 border-x-0 shadow-none"
              />
              <Input
                type="text"
                name="firstName"
                ...
                className="bg-white lg:w-full  border border-b placeholder-black border-t-0 border-x-0 shadow-none"
              />
            </div>
            <Input
              type="text"
          ...
          <Button className="w-full bg-primary-blue mt-3 lg:mt-5 lg:w-2/5 lg:mb-5">
            Create Account
          </Button>
