...
const TemplatePage: React.FC = () => {
  ...
  return (
    <div>
<div className="md:hidden top-8 left-4 z-10 ml-4">
  <button
  ...
  >
    ...
    Back
      ...
      <div className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: "url('/Images/templates/Frame.svg')" }}>
        <div className="absolute inset-0 flex flex-col justify-start p-4 text-white">
          ...
          <div className="flex items-center justify-center flex-col mt-4">
            ...
            <div className="mt-4 text-md md:text-lg flex flex-wrap justify-center">
              ...
              <div className="flex items-center mr-4 mb-4 md:ml-4">
